...
signAcademicHonestyPolicy('Yibo Kong', 'ykong42');
...
%xp1 = src_x(1);xp2 = src_x(2);xp3 = src_x(3);xp4 = src_x(4);
%yp1 = src_y(1);yp2 = src_y(2);yp3 = src_y(3);yp4 = src_y(4);

%xb1 = dst_x(1);xb2 = dst_x(2);xb3 = dst_x(3);xb4 = dst_x(4);
%yb1 = dst_y(1);yb2 = dst_y(2);yb3 = dst_y(3);yb4 = dst_y(4);

portrait_pts = [7 8; 320 8; 9 393; 321 393];
bg_pts = [106 27;270 76; 91 433; 279 420];
...
ransac_n = 200; % Max number of iterations
...
% Your own panorama
imgc = im2single(imread('town_center.jpg'));
imgl = im2single(imread('town_left.jpg'));
imgr = im2single(imread('town_right.jpg'));
...
%figure, imshow(stitched_img);
imwrite(stitched_img, 'town_panorama.png');
